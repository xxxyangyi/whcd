    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="col-lg-12">
                详情：
                <br/>
                <img alt="" src="<%=request.getContextPath()%><%=scenery.getPicaddr()%>"
                     style="float: right;margin: 5px;" onload="AutoResizeImage(300,0,this)"
            ...
            <div class="col-lg-12">
                ...
                <br/>
                创建日期：
                <date><fmt:formatDate value="<%=scenery.getCreateDate()%>" pattern="yyyy-MM-dd"/></date>
            </div>
        </div>
